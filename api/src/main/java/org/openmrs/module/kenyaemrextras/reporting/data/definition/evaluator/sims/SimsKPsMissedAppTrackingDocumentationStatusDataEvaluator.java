...
/**
 * Evaluates whether missed appointment KPS had tracking done
 */
@Handler(supports = SimsKPsMissedAppTrackingDocumentationStatusDataDefinition.class, order = 50)
public class SimsKPsMissedAppTrackingDocumentationStatusDataEvaluator implements PersonDataEvaluator {
	...
	public EvaluatedPersonData evaluate(PersonDataDefinition definition, EvaluationContext context)
		...
		String qry = "select a.patient_id, if(a.tracking_date > a.latest_app_date, 'Y', 'N')\n"
