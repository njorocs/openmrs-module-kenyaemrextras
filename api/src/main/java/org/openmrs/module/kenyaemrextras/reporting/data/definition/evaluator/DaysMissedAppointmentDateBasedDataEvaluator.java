...
public class DaysMissedAppointmentDateBasedDataEvaluator implements PersonDataEvaluator {
	...
	public EvaluatedPersonData evaluate(PersonDataDefinition definition, EvaluationContext context)
		...
		String qry = "select a.patient_id,if(days_missed < 0, refill_days_missed,ifnull(refill_days_missed,days_missed)) as days_missed\n"
		        ...
		        + "                                 and (f7.return_date = f0.visit_date or f7.refill_return_date = f0.visit_date) -- check whether this is accurate\n"
