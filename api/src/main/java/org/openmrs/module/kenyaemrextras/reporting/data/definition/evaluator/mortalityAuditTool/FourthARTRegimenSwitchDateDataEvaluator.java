...
import org.openmrs.module.kenyaemrextras.reporting.data.definition.mortalityAuditTool.FourthARTRegimenSwitchDateDataDefinition;
...
/**
 * Evaluates date of Fourth ART regimen switch Data Definition
 */
@Handler(supports = FourthARTRegimenSwitchDateDataDefinition.class, order = 50)
public class FourthARTRegimenSwitchDateDataEvaluator implements PersonDataEvaluator {
	...
	public EvaluatedPersonData evaluate(PersonDataDefinition definition, EvaluationContext context)
		...
		String qry = "select f.patient_id,f.date_discontinued from\n" +
				...
				"    ) t\n" +
				"where rn=4)n on n.patient_id= e.patient_id group by e.patient_id)f;";
