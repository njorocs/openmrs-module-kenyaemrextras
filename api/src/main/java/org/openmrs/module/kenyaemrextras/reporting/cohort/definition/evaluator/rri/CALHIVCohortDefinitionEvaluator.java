 ...
 */
@Handler(supports = { CALHIVCohortDefinition.class })
public class CALHIVCohortDefinitionEvaluator implements CohortDefinitionEvaluator {
	...
	public EvaluatedCohort evaluate(CohortDefinition cohortDefinition, EvaluationContext context) throws EvaluationException {
		...
		CALHIVCohortDefinition definition = (CALHIVCohortDefinition) cohortDefinition;
