...
import org.openmrs.module.kenyaemrextras.reporting.data.definition.mortalityAuditTool.FourthRegimenDataDefinition;
...
/**
 * Evaluates FourthRegimenDataDefinition
 */
@Handler(supports = FourthRegimenDataDefinition.class, order = 50)
public class FourthRegimenDataEvaluator implements PersonDataEvaluator {
