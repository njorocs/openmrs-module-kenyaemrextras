...
public class MissedAppointmentsRTC8To30DaysCohortDefinitionEvaluator implements CohortDefinitionEvaluator {
	...
	public EvaluatedCohort evaluate(CohortDefinition cohortDefinition, EvaluationContext context) throws EvaluationException {
		...
		String qry = "select a.patient_id\n"
		        ...
		        + "                                                           -- f6.refill_visit_date as refill_visit_date,\n"
		        ...
		        + "                                                                mid(max(concat(f7.visit_date, f7.refill_date)), 11) as latest_refill\n"
		        ...
		        + "                             having latest_appointment between date(:startDate) and date(:endDate) or latest_refill between date(:startDate) and date(:endDate)\n"
		        + "                         ) r\n"
		        ...
		        + "              where timestampdiff(DAY,next_appointment_date,return_date) between 8 and 30 or timestampdiff(DAY,refill_tca,refill_return_date) between 8 and 30;";
