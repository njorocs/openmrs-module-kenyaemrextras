...
public class ReturnToCareDateBasedDateDataEvaluator implements PersonDataEvaluator {
	...
	public EvaluatedPersonData evaluate(PersonDataDefinition definition, EvaluationContext context)
		...
		String qry = "select a.patient_id, if(a.return_date = a.app_visit,if(a.refill_return_date = a.app_visit,null,a.refill_return_date), a.return_date) as return_date\n"
		        + "from (select r.patient_id,\n"
		        + "             r.app_visit,\n"
		        + "             r.return_date,\n"
		        + "             least(ifnull(r.refill_return_date,r.return_date),r.return_date) as rtc_date,\n"
		        + "             r.refill_return_date,\n"
		        + "             r.next_appointment_date as next_appointment_date,\n"
		        + "             r.refill_tca as refill_tca,\n"
		        ...
		        + "               having latest_appointment between date(:startDate) and date(:endDate) or latest_refill_tca between date(:startDate) and date(:endDate)) r\n"
