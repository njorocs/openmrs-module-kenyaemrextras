...
import org.openmrs.module.kenyaemrextras.reporting.data.definition.mortalityAuditTool.SecondRegimenDataDefinition;
...
/**
 * Evaluates SecondRegimenDataDefinition
 */
@Handler(supports = SecondRegimenDataDefinition.class, order = 50)
public class SecondRegimenDataEvaluator implements PersonDataEvaluator {
